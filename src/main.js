...
( () => {
    ...
    var i, a, o, u, c, s, l, f, d, v, m, p, h, g, y, T, S, E, b, L, w, C, M, x, A, k, F, I, B, D, P, R, N, q, H, O, V, U, _, j, J, $, z, G, K, Q, W, X, Y, Z, ee, et, en, er, ei, ea, eo, eu, ec, es, el, ef = e( () => {}
    ), ed = e( () => {
        s = function() {
        ...
        g = function(e, t) {
            var n = s()
              , r = "navigate";
            return m() >= 0 ? r = "back-forward-cache" : n && (document.prerendering || h() > 0 ? r = "prerender" : document.wasDiscarded ? r = "restore" : n.type && (r = n.type.replace(/_/g, "-"))),
            {
                name: e,
                value: void 0 === t ? -1 : t,
                rating: "good",
        ...
        ,
        C = function(e) {
            "hidden" === document.visibilityState && L > -1 && (L = "visibilitychange" === e.type ? e.timeStamp : 0,
            x())
        }
        ,
        M = function() {
        ...
        I = function(e, t) {
            t = t || {},
            k(function() {
                var n, r = A(), i = g("FCP"), a = y("paint", function(e) {
                    e.forEach(function(e) {
                        "first-contentful-paint" === e.name && (a.disconnect(),
                        e.startTime < r.firstHiddenTime && (i.value = Math.max(e.startTime - h(), 0),
                        i.entries.push(e),
                        n(!0)))
                    })
                });
                a && (n = T(e, i, F, t.reportAllChanges),
                p(function(r) {
                    n = T(e, i = g("FCP"), F, t.reportAllChanges),
                    S(function() {
        ...
        D = function(e, t) {
            ...
            r = (r = t) || {},
            I(b(function() {
                var e, t = g("CLS", 0), i = 0, a = [], o = function(n) {
                ...
                u && (e = T(n, t, B, r.reportAllChanges),
                E(function() {
                    o(u.takeRecords()),
                    e(!0)
                }),
                p(function() {
                    i = 0,
                    e = T(n, t = g("CLS", 0), B, r.reportAllChanges),
                    S(function() {
                        return e()
                    })
                }),
                    ...
                    if (e.entries.length) {
                        ...
                        if (t) {
                            ...
                            return void (e.attribution = {
                                ...
                                loadState: l(e.entries[0].startTime),
                                navigationEntry: t,
                                fcpEntry: n
                            })
                        }
        ...
        O = function(e) {
            if (e.cancelable) {
                ...
                addEventListener("pointercancel", n, R)) : q(i, e)
            }
        }
        ,
        V = function(e) {
        ...
        _ = function(e, t) {
            t = t || {},
            k(function() {
                var n, r = A(), o = g("FID"), c = function(e) {
                ...
                n = T(e, o, U, t.reportAllChanges),
                l && E(b(function() {
                    s(l.takeRecords()),
                    l.disconnect()
                })),
                l && p(function() {
                    n = T(e, o = g("FID"), U, t.reportAllChanges),
                    u = [],
                    a = -1,
                    i = null,
                    V(addEventListener),
        ...
        j = function(e, t) {
            _(function(t) {
                ...
                r = (n = t).entries[0],
                n.attribution = {
                    eventTarget: d(r.target),
                    eventType: r.name,
                    eventTime: r.startTime,
                    eventEntry: r,
                    loadState: l(r.startTime)
                },
                e(t)
            }, t)
        }
        ...
        G = function(e) {
            e.forEach(function(e) {
                e.interactionId && ($ = Math.min($, e.interactionId),
                J = (z = Math.max(z, e.interactionId)) ? (z - $) / 7 + 1 : 0)
            })
        }
        ,
        K = function() {
            return c ? J : performance.interactionCount || 0
        }
        ,
        Q = function() {
            "interactionCount"in performance || c || (c = y("event", G, {
                type: "event",
                buffered: !0,
                durationThreshold: 0
            }))
        ...
        en = function(e, t) {
            ...
            k(function() {
                Q();
                var n, r = g("INP"), i = function(e) {
                    e.forEach(function(e) {
                        e.interactionId && et(e),
                    ...
                    var t = Z[Math.min(Z.length - 1, Math.floor(Y() / 50))];
                ...
                p(function() {
                    Z = [],
                    X = K(),
                    n = T(e, r = g("INP"), W, t.reportAllChanges)
                }))
            })
        }
        ,
        ...
        eo = function(e, t) {
                    ...
                    if (e.entries.length) {
                        ...
                        if (t) {
                            var n = t.activationStart || 0
                              ...
                              , c = Math.max(u, r ? r.startTime - n : 0)
                              , l = {
                                element: d(r.element),
                                timeToFirstByte: a,
            ...
            r = (r = t) || {},
            k(function() {
                var e, t = A(), i = g("LCP"), a = function(n) {
                    var r = n[n.length - 1];
                    r && r.startTime < t.firstHiddenTime && (i.value = Math.max(r.startTime - h(), 0),
                    i.entries = [r],
                    e())
                }, o = y("largest-contentful-paint", a);
                if (o) {
                    e = T(n, i, ei, r.reportAllChanges);
                    var u = b(function() {
                        ea[i.id] || (a(o.takeRecords()),
                        o.disconnect(),
                        ea[i.id] = !0,
                        e(!0))
                    });
                    ...
                    E(u),
                    p(function(t) {
                        e = T(n, i = g("LCP"), ei, r.reportAllChanges),
                        S(function() {
            ...
            ec(function() {
                ...
                if (i) {
                    ...
                    if (a <= 0 || a > performance.now())
                        return;
                    n.value = Math.max(a - h(), 0),
                    n.entries = [i],
                    r(!0),
                    p(function() {
                        (r = T(e, n = g("TTFB", 0), eu, t.reportAllChanges))(!0)
                    })
                }
            })
        }
    ...
    function ey(e) {
        return "CLS" === e.name ? eg(e.value, 4) : "FID" === e.name ? eg(e.value, 2) : Math.round(e.value)
    }
    var eT = e( () => {
        ed()
    }
    ...
    t( () => {
        ...
        function() {
            ...
            if (r())
                return;
            let a = null == i ? void 0 : i.dataset.dsn
              , o = (null == i ? void 0 : i.dataset.endpoint) || (a ? `https://vitals.vercel-insights.com/v2/vitals?dsn=${a}&ve=production` : "/_vercel/speed-insights/vitals")
              , u = () => {
                var n, r;
                let a = ev()
                  , u = e.map(e => ({
                ...
                0 !== u.length && (ep({
                    ...
                    metrics: u,
                    scriptVersion: "0.1.3",
                    sdkName: null != (n = null == i ? void 0 : i.getAttribute("data-sdkn")) ? n : void 0,
                    sdkVersion: null != (r = null == i ? void 0 : i.getAttribute("data-sdkv")) ? r : void 0
                }, o),
                e = [])
            }
              , c = () => {
            ...
            ( () => {
                ...
                if (window.sil)
                    return;
                window.sil = !0;
                let r = Number(null != (t = null == i ? void 0 : i.dataset.sampleRate) ? t : 1);
                if (!(1 === r || Math.random() <= r))
                    return;
                em(t => {
                    e.push({
                        ...t,
